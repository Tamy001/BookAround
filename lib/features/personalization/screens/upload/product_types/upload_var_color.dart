...
class UploadColorProducts extends StatelessWidget {
  const UploadColorProducts({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: TAppBar(
            showBackArrow: true,
            title: Text('With Color Variants',
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    ///COLOR VARIATION
                    TextFormField(
                      controller: contoller.varColor,
                      validator: (value) => TValidator.validateEmptyText(
                          'Variation Cover', value),
                      expands: false,
                      decoration: const InputDecoration(
                          labelText: TTexts.uploadColor,
                          prefixIcon: Icon(Iconsax.image)),
                    ),
                    const SizedBox(height: TSizes.spaceBtwInputFields),
                    ...
                    ///COLOR VARIATION
                    TextFormField(
                      controller: contoller.varColor2,
                      validator: (value) => TValidator.validateEmptyText(
                    ...
                    SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed: () => contoller.addColorProduct(),
